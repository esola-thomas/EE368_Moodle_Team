...
/**
 * Question type class for the RegEx question type.
 *
 * @package    qtype
 * @subpackage regex
...
require_once($CFG->dirroot . '/question/type/regex/question.php');


/**
 * The RegEx question type.
 *
 * @copyright  1999 onwards Martin Dougiamas  {@link http://moodle.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_regex extends question_type {
    public function extra_question_fields() {
        return array('qtype_regex_options', 'usecase');
    }
