...
/**
 * Strings for component 'qtype_regex', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
 * @subpackage regex
...
$string['pluginname_link'] = 'question/type/regex';
$string['pluginnameadding'] = 'Adding a RegEx question';
$string['pluginnameediting'] = 'Editing a RegEx question';
$string['pluginnamesummary'] = 'Allows a response that is graded by a regular expression.';
$string['privacy:metadata'] = 'RegEx question type plugin allows question authors to set default options as user preferences.';
